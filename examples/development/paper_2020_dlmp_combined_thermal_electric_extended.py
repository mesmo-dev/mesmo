...
def main(
    ...
    if scenario_number in [1, 2, 3, 4, 5]:
        scenario_name = 'paper_2021_1_scenario_1_2_3_4_5'
    elif scenario_number in [6, 7, 8]:
        scenario_name = 'paper_2021_1_scenario_6_7_8'
    elif scenario_number in [9]:
        scenario_name = 'paper_2021_1_scenario_9'
    elif scenario_number in [10, 11, 12]:
        scenario_name = 'paper_2021_1_scenario_10_11_12'
    elif scenario_number in [13]:
        scenario_name = 'paper_2021_1_scenario_13'
    elif scenario_number in [14]:
        scenario_name = 'paper_2021_1_scenario_14'
    elif scenario_number in [15]:
        scenario_name = 'paper_2021_1_scenario_15'
    else:
        scenario_name = 'paper_2021_1_scenario_1_2_3_4_5'
    ...
    power_flow_solution = fledge.electric_grid_models.PowerFlowSolutionFixedPoint('paper_2021_1_scenario_1_2_3_4_5')
    ...
    # Use base scenario power flow for consistent linear model behavior and per unit values.
    # TODO: Fix reliance on default scenario power flow.
    thermal_power_flow_solution = fledge.thermal_grid_models.ThermalPowerFlowSolution('paper_2021_1_scenario_1_2_3_4_5')
