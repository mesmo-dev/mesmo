...
def main(
    ...
    # Choices:
    # 1 - fixed loads and generators only,
    # 2 - half of the loads flexible, all generators flexible,
    # 3 - as in scenario 2 with additional conversion units
    if scenario_number in [1]:
        scenario_name = 'MES_scenario_1'
    elif scenario_number in [2]:
        scenario_name = 'MES_scenario_2'
    elif scenario_number in [3]:
        scenario_name = 'MES_scenario_3'

    else:
        scenario_name = 'MES_ISGT_scenario_3'
    ...
    print(thermal_grid_model)
    thermal_power_flow_solution = fledge.thermal_grid_models.ThermalPowerFlowSolution(scenario_name)
