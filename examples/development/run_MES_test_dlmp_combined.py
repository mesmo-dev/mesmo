...
def main():
    ...
    thermal_grid_model.cooling_plant_efficiency = 0  # TODO: Document modifications for Thermal Electric DLMP paper
    thermal_grid_model.heat_pump_efficiency = 5
